...
export const services = [
  {
    ...
    title: "Mobile Apps",
    desc: "Designing and developing responsive, user-friendly mobile applications for Android and iOS using modern frameworks.",
  },
  {
    id: 2,
    icon: <MdOutlineMonitor size={40} />,
    title: "Frontend",
    desc: "Building intuitive and dynamic user interfaces with a focus on performance, accessibility, and cross-browser compatibility.",
  },
  {
    id: 3,
    icon: <FaCode size={40} />,
    title: "Backend",
    desc: "Developing robust, scalable backend systems, RESTful APIs, and secure data handling using modern server-side technologies.",
  },
];
...
export const experiences: InfoContainerItem[] = [
  {
    ...
    company: "Protco Technologies Pvt. Ltd.",
    desc: "Leading the development of smart home automation solutions, integrating IoT devices with scalable mobile applications, and optimizing real-time control systems.",
  },
  {
    id: 2,
    start: "Oct 2021",
    ...
    desc: "Designed and implemented end-to-end features for enterprise-grade systems, improved system performance, and contributed to DevOps automation.",
  },
  {
    id: 3,
    start: "Apr 2021",
    ...
    desc: "Built and maintained full-stack applications using modern JavaScript frameworks, REST APIs, and cloud services.",
  },
];
...
export const education: InfoContainerItem[] = [
  {
    ...
    desc: "Completed a rigorous postgraduate program focused on software development, algorithms, and system programming using modern technologies.",
  },
  {
    id: 2,
    start: "Jul 2011",
    ...
    company: "RGTU, Bhopal",
    desc: "Studied core subjects in electronics and communication engineering, including embedded systems, digital electronics, and signal processing.",
  },
  {
    id: 3,
    start: "Jul 2010",
    end: "Mar 2011",
    title: "HSC (12th Maths)",
    company: "MPBSE, Bhopal",
    desc: "Completed higher secondary education with a focus on mathematics, physics, and chemistry.",
  },
  {
    id: 4,
    start: "Jul 2008",
    end: "Mar 2009",
    title: "SSC (10th Common)",
    company: "MPBSE, Bhopal",
    desc: "Completed secondary education with a well-rounded curriculum including science, mathematics, and languages.",
  },
];
